...
function changeLinkText(lnk) {
    ...
    switch (lnk) {
     case'home' : 
        ...
        document.getElementById('rs_Heading').innerHTML = "Intro to Programming <br>w/HTML, CSS & JavaScript to Programming w/HTML, CSS & JavaScript";
        break;
    case'classEx':
        ...
        document.getElementById('divLeft_ALinks').style.display = "none";
        document.getElementById('divLeft_RLinks').style.display = "none";
        document.getElementById('divRight').innerHTML= "Defaul descripton for Class Exercise Link";
    ...
    case 'assign':
        ...
        document.getElementById('divLeft_RLinks').style.display = "none";
        document.getElementById('divRight').innerHTML= "Defaul descripton for Assignment Link";
    ...
    case 'resource':
        ...
        document.getElementById('divRight').innerHTML= "Defaul descripton for Resources Link";
        document.getElementById('ls_Heading').innerHTML = "Resource";
